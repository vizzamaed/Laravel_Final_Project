...
<body class="h-full font-sans">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm text-center">
          ...
          <p class= "text-sm">Get ready to streamline your day and conquer your tasks with ease. Log in now to begin your productivity journey!</p>
          <h2 class="mt-10  text-1xl font-bold leading-9 tracking-tight text-gray-900">Log in to your account</h2>
        </div>
        ...
        <div class="mt-1 sm:mx-auto sm:w-full sm:max-w-sm">
          <form class="space-y-6" action="/login/process" method="POST">
            ...
            <div>
              <button type="submit" class="flex w-full justify-center rounded-md bg-sky-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">Log in</button>
            </div>
          </form>
        </div>
      </div>
